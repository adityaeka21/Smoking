...
class SimulasiModelActivity : AppCompatActivity() {
    ...
    private val mModelPath = "smoking.tflite"
    ...
    private lateinit var oral: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkButton.setOnClickListener {
            ...
            runOnUiThread {
                if (result == 0) {
                    resultText.text = "Tidak merokok"
                }else if (result == 1){
                    resultText.text = "Merokok"
                }
            }
        }
        initInterpreter()
